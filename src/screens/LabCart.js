...
import { useGetAllLabCartItemsQuery,useTestsAndPackagesByIdQuery,useDeleteLabCartItemsMutation } from '../services/userAuthApi'
...
const LabCart = () => {
  ...
  const {data,isLoading,isFetching,error,isSuccess,refetch}=useGetAllLabCartItemsQuery(userLToken,{ refetchOnMountOrArgChange: true })
