...
const DiagSearch = () => {
  ...
  const {data,isSuccess,isError}=useSearchTestsAndPackagesQuery(searchQuery)
 ...
 { isSuccess && data.data.forEach((item)=>{
  ...
  return (
    <View>
      ...
      <View>      
    <TextInput placeholder={"Search For Tests, Health Packages"} onChangeText={text => handleChange(text)}/>
