...
useEffect(()=>{
  ...
  const queryItems2={
    ...
    const {data,isLoading,isFetching,error,isSuccess}=useGetDoctorQuery(queryItems)
  ...
  return (
    <SafeAreaView>
            ...
            renderItem={({ item, index }) => {
              ...
              return (
                ...
                <View style={styles.slot}>
                    ...
                    <FlatList data={Timeslots[0]}
                        horizontal
                        renderItem={(item,index)=>{
                            return(
                              <TouchableOpacity onPress={() => { SetTimeSlot({
                                "date": item.item.date,
      ...
      <Dropdown
        ...
        data={dropData} onChangeText={(optype) => setSelectedOpType(optype)}
